package goveed20.LiteraryAssociationApplication.elasticsearch.configurations;

import java.io.File;
import java.util.ArrayList;
import java.util.Collection;

import goveed20.LiteraryAssociationApplication.elasticsearch.plugin.SerbianPlugin;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "goveed20.LiteraryAssociationApplication.elasticsearch.repositories")
